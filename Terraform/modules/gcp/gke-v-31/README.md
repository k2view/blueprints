# GCP GKE Module (v31.1.0)
Creates a private GKE cluster using the `terraform-google-modules/kubernetes-engine/google//modules/private-cluster` module (v31.1.0). Also provisions a dedicated GKE service account and the default storage class.
...
| Name | Source | Version |
|------|--------|---------|
| gke | terraform-google-modules/kubernetes-engine/google//modules/private-cluster | 31.1.0 |
