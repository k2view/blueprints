...
This submodule is part of the the `GCP-network` module. It creates the individual vpc routes and optionally deletes the default internet gateway routes.
...
```hcl
module "route" {
    source  = "../GCP/Modules/Network/routes"
